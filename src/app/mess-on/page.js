...
function GatePass() {
    ...
    const submit = () => {
        ...
        // return;
        if (!leavePass.name || !leavePass.rollNo || !leavePass.date || !leavePass.hostel || !leavePass.roomNo) {
            window.alert("Please enter details correctly");
        }

        addDoc(collection(db, `mess/messon/${user?.email}`), { ...leavePass, date: serverTimestamp() })
            .then((result) => {
                window.alert("Mess on successful...");
                setLeavePass(
                    {
                        name: undefined,
                        rollNo: undefined,
                        ...
                        <section class="text-gray-600 body-font relative">
                            <div class="container px-5 py-24 mx-auto">
                                <div class="flex flex-col text-center w-full mb-12">
                                    <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Mess On</h1>
                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="p-2 w-1/2">
                                            <div class="relative">
                                                ...
                                                <input type="text" id="name" onChange={onchange} name="date" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                                            </div>
                                        </div>
                                        <div class="p-2 w-1/2">
                                            <div class="relative">
