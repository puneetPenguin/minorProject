      ...
      <>
        ...
        >
          <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
            <Link href="/">
              <img src="https://thumbs.dreamstime.com/b/vector-logo-hostel-hotel-183952406.jpg" className='h-20 w-20' alt="Logo" />
            </Link>
            ...
            <nav class="mt-5 py-4 px-4 lg:mt-9 lg:px-6" x-data="{selected: $persist('Dashboard')}">
              <div>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                  <li>
                    <Link href="/" class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                    >
                  ...
                  <li>
                    <Link href="/calender" class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                    >
                      <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                  ...
                  <li>
                    <Link href="/profile" class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                  ...
                  <li>
                    ...
                    <div class="overflow-hidden" >
                      <ul class=" mb-4 mt-1 mb-5.5 flex flex-col gap-2.5 pl-6">
                        <li>
                          <Link href="/gate-pass" class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out "
                          >Gate Pass</Link>
                        </li>
                        <li>
                          <Link href="/leave-pass" class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out " >Leave Pass</Link>
                        </li >
                      </ul >
                    </div >
                  </li >
                  <li>
                    <Link href="mess-off" class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                  ...
                  <li>
                    <Link href="mess-on" class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                  ...
                  <li>
                    <Link href="/complaint" class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                    >
                      <svg class="fill-current" width="18" height="19" viewBox="0 0 18 19" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
              ...
              <div>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                  ...
                  <li>
                    <Link href="/attendance" class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                    >
                      <svg class="fill-current" width="18" height="19" viewBox="0 0 18 19" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
